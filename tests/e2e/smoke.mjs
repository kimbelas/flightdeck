...
import { daemonChecks } from './smoke/daemon-checks.mjs';
...
import { spendChecks } from './smoke/spend-checks.mjs';
...
try {
  ...
  await daemonChecks(page, report, core);
  ...
  // After it, on the folder it left imported: the panel names a slug by the registry (P7-T3).
